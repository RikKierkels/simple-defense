            ...
            (n = Math.floor),
              ...
              (f = function(t, e, n) {
                ...
                return (
                  null == n && (n = i),
                  (o = t.indexOf(e)),
                  -1 !== o ? (d(t, 0, o, n), g(t, o, n)) : void 0
                );
              }),
              (p = function(t, e, n) {
                var r, a, l, h, u;
                if ((null == n && (n = i), (a = t.slice(0, e)), !a.length))
                  return a;
                for (o(a, n), u = t.slice(e), l = 0, h = u.length; h > l; l++)
                  (r = u[l]), s(a, r, n);
              ...
              (c = function(t, e, n) {
                ...
                if ((null == n && (n = i), 10 * e <= t.length)) {
                  ...
                  for (
                    l = p[p.length - 1], g = t.slice(e), c = 0, d = g.length;
                    d > c;
                    c++
                  )
                    (a = g[c]),
                      n(a, l) < 0 &&
                        (h(p, a, 0, null, n), p.pop(), (l = p[p.length - 1]));
                  return p;
                }
                for (
                  o(t, n), v = [], s = f = 0, b = u(e, t.length);
                  b >= 0 ? b > f : f > b;
                  s = b >= 0 ? ++f : --f
                )
                  v.push(r(t, n));
        ...
        function(t, e, i) {
          ...
          function l(t, e) {
            ...
            for (i = g, n = b, s = [[i, n]], l = 2; d > l; ++l) {
              for (
                u = e[l], o = u[0], r = u[1], p = a(i, n, o, r), f = !1, h = 1;
                h < p.length;
                ++h
              )
                ...
                if (((h = l[u]), !h.closed)) {
                  ...
                  (c = h.x),
                    ...
                    (!h.opened || d < h.g) &&
                      ...
                      (h.f = h.g + h.h),
                      (h.parent = s),
                      h.opened ? v.updateItem(h) : (v.push(h), (h.opened = x)));
                }
            }
            return [];
          }),
        ...
        function(t, e, i) {
          ...
          (n.prototype.findPath = function(t, e, i, n, r) {
            ...
            for (p.push(f), f.opened = !0; p.length; ) {
              if (((l = p.shift()), (l.closed = !0), l === d))
                return o.backtrace(d);
              for (a = r.getNeighbors(l, c), h = 0, u = a.length; u > h; ++h)
                (s = a[h]),
                  s.closed ||
                    s.opened ||
            ...
            var a,
              ...
              f = function(t, e, i, n, a) {
                ...
                var l,
                  ...
                  b,
                  v,
                  A = o.getNeighbors(t, this.diagonalMovement);
                for (b = 0, l = 1 / 0; (v = A[b]); ++b) {
                  if (
                    (this.trackRecursion &&
                      ((v.retainCount = v.retainCount + 1 || 1),
                      v.tested !== !0 && (v.tested = !0)),
                    (d = f(v, e + c(t, v), i, n, a + 1)),
                    d instanceof r)
                  )
                    return (n[a] = [t.x, t.y]), d;
                  this.trackRecursion &&
                    0 === --v.retainCount &&
                    (v.tested = !1),
                    l > d && (l = d);
          ...
          (n.prototype = new o()),
            ...
            (n.prototype._findNeighbors = function(t) {
              ...
              if (u)
                ...
                for (
                  a = f.getNeighbors(t, r.Always), l = 0, h = a.length;
                  h > l;
                  ++l
                )
          ...
          (n.prototype = new o()),
            ...
            (n.prototype._findNeighbors = function(t) {
              ...
              if (u)
                ...
                for (
                  a = f.getNeighbors(t, r.IfAtMostOneObstacle),
                    l = 0,
                    h = a.length;
                  h > l;
                  ++l
          ...
          (n.prototype = new o()),
            ...
            (n.prototype._findNeighbors = function(t) {
              ...
              if (u)
                ...
                for (
                  a = f.getNeighbors(t, r.OnlyWhenNoObstacles),
                    l = 0,
                    h = a.length;
                  h > l;
                  ++l
          ...
          (n.prototype = new o()),
            ...
            (n.prototype._findNeighbors = function(t) {
              ...
              if (u)
                ...
                for (
                  a = f.getNeighbors(t, r.Never), l = 0, h = a.length;
                  h > l;
                  ++l
                )
                  (s = a[l]), d.push([s.x, s.y]);
      ...
      22: [
        function(t, e, i) {
          function n(t) {
            return (
              (t = t || {}),
              t.diagonalMovement === o.Never
                ? new r(t)
                : t.diagonalMovement === o.Always
                ? new a(t)
                : t.diagonalMovement === o.OnlyWhenNoObstacles
                ? new s(t)
                : new l(t)
            );
          }
            ...
            (n.prototype._identifySuccessors = function(t) {
              ...
              for (e = this._findNeighbors(t), o = 0, r = e.length; r > o; ++o)
                if (((i = e[o]), (n = this._jump(i[0], i[1], v, A)))) {
                  if (
                    ((s = n[0]), (l = n[1]), (p = c.getNodeAt(s, l)), p.closed)
                  )
                    continue;
